							...
							Else
								...
								Else
									...
									If $wait == "Windows Security" Then
										ControlSend( "[CLASS:#32770;TITLE:Windows Security]", "","[CLASS:#32770;TITLE:Windows Security]","{DOWN}", )
										ControlSend( "[CLASS:#32770;TITLE:Windows Security]", "","[CLASS:#32770;TITLE:Windows Security]","{DOWN}", )
										ControlSend( "[CLASS:#32770;TITLE:Windows Security]", "","[CLASS:#32770;TITLE:Windows Security]","{ENTER}", )
