				...
				Else
					...
					Else
						...
						Else
							...
							Msgbox(0,"NU E-mail Config","Please populate the 'Add New Account' window with needed information and then click Next.")
							...
							if ( $wait<>0 and $userquit==1) then
								;Msgbox(0,"NUConfig","Please BLAH BLAH BLAH.  User ADS\NetID as your username.")
								#comments-start
								If $result = 0 Then
									ControlClick ( "[CLASS:#32770;TITLE:Add New]", "", "[CLASS:Button; INSTANCE:8]")
								Else
									ControlClick ( "[CLASS:#32770;TITLE:Add New]", "", "[CLASS:Button; INSTANCE:5]")
								EndIf
								...
								do
									...
									Else
										...
										Else
											If $wait = 0 then
												$wait = WinExists("[CLASS:#32770;TITLE:Add New]", "Your e-mail account is successfully configured.")
											EndIf
											If $wait <> 0 then
										...
										EndIf
									EndIf
								Until ($x = 50000 or $userquit==0 or $wait == "Connect to" or $wait == "Add New Account" or $wait == "Microsoft Outlook" or $wait == "Windows Security")
